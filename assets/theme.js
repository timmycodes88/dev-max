...
window.addEventListener('DOMContentLoaded', function() {
  setTimeout(updateTextOfMorePaymentButton, 100);
  setTimeout(updateTextOfMorePaymentButton, 200);
  setTimeout(updateTextOfMorePaymentButton, 300);
  setTimeout(updateTextOfMorePaymentButton, 400);
  setTimeout(updateTextOfMorePaymentButton, 500);
  setTimeout(updateTextOfMorePaymentButton, 600);
  setTimeout(updateTextOfMorePaymentButton, 700);
  setTimeout(updateTextOfMorePaymentButton, 800);
  setTimeout(updateTextOfMorePaymentButton, 900);
  setTimeout(updateTextOfMorePaymentButton, 1000);
  setTimeout(updateTextOfMorePaymentButton, 1100);
  setTimeout(updateTextOfMorePaymentButton, 1200);
  setTimeout(updateTextOfMorePaymentButton, 1300);
  setTimeout(updateTextOfMorePaymentButton, 1400);
  setTimeout(updateTextOfMorePaymentButton, 1500);
  setTimeout(updateTextOfMorePaymentButton, 1600);
  setTimeout(updateTextOfMorePaymentButton, 1700);
  setTimeout(updateTextOfMorePaymentButton, 1800);
  setTimeout(updateTextOfMorePaymentButton, 1900);
  setTimeout(updateTextOfMorePaymentButton, 2000);
  setTimeout(updateTextOfMorePaymentButton, 2250);
  setTimeout(updateTextOfMorePaymentButton, 2500);
  setTimeout(updateTextOfMorePaymentButton, 2750);
  setTimeout(updateTextOfMorePaymentButton, 3000);
  setTimeout(updateTextOfMorePaymentButton, 5000);
})

$(theme.init);

function updateTextOfMorePaymentButton() {
  console.log("Change Text");
  let timsBtn = document.querySelector(".shopify-payment-button__more-options");

  timsBtn.textContent = "Buy Now Credit/Debit Card";
}